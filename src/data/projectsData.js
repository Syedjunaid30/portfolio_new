export const projectsData = [
  {
    ...
    techStack: ['HTML', 'CSS', 'JavaScript', 'Python Flask', 'MySQL', 'Face Recognition'],
    liveLink: '#',
    githubLink: '#',
  ...
  },
  {
    ...
    techStack: ['Python', 'Flask', 'Deep Learning', 'Wav2Lip', 'HTML/CSS', 'AI/ML'],
    liveLink: '#',
    githubLink: '#',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1559028006-448665bd7c7f?w=800&h=500&fit=crop',
  ...
  },
  {
    ...
    techStack: ['Python', 'NLP', 'SQL', 'Data Visualization', 'Machine Learning', 'AI'],
    liveLink: '#',
    githubLink: '#',
